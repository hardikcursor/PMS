        ...
        <div class="row g-4 mb-4">
            <div class="col-lg-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <canvas id="revenueChart2" height="140"></canvas>
                    </div>
                </div>
            </div>
            ...
            <script>
                document.addEventListener("DOMContentLoaded", function() {
                    ...
                    const monthMap = {
                        '01': 'Jan','1': 'Jan','January': 'Jan','02': 'Feb','2': 'Feb','February': 'Feb','03': 'Mar','3': 'Mar','March': 'Mar','04': 'Apr','4': 'Apr','April': 'Apr','05': 'May','5': 'May','06': 'Jun','6': 'Jun','June': 'Jun','07': 'Jul','7': 'Jul','July': 'Jul','08': 'Aug','8': 'Aug','August': 'Aug','09': 'Sep','9': 'Sep','September': 'Sep','10': 'Oct','October': 'Oct','11': 'Nov','November': 'Nov','12': 'Dec','December': 'Dec'
                    };
                                ...
                                tooltip: {
                                    callbacks: {
                                        ...
                                        label: context => {
                                            ...
                                            if (dataset.includes('Amount')) return ' Amount: ₹' + val.toLocaleString();
                    ...
                    var options = {
                        ...
                        plotOptions: {
                            radialBar: {
                                hollow: { size: '70%' },
                                dataLabels: {
                                    name: { show: true, color: '#fff', offsetY: -10, text: 'Total Income' },
                                    value: { show: true, color: '#fff', fontSize: '22px', formatter: () => '₹' + total.toLocaleString() }
                                }
                            }
                        },
            ...
            <script>
                document.addEventListener("DOMContentLoaded", function() {
                    ...
                    if (!rawData || Object.keys(rawData).length === 0) {
                        container.innerHTML = '<p class="text-muted text-center mt-3">No data available for the last 7 days.</p>';
                        return;
                    }
                    ...
                    new Chart(ctx, {
                        ...
                        options: {
                            ...
                            plugins: {
                                ...
                                tooltip: { callbacks: { label: function(context) { return context.label + ': ' + context.raw + ' vehicles'; } } }
                            }
                        }
                    });
                });
