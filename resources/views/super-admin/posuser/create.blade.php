        ...
        <div class="container-fluid">
            ...
            <div class="row justify-content-center">
                <div class="col-xl-8 col-lg-10">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title mb-4">Create POS User</h4>

                            <form method="POST" action="{{ route('superadmin.posuser.store') }}">
                                @csrf
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="UserName" class="form-control @error('UserName') is-invalid @enderror"
                                               value="{{ old('UserName') }}" placeholder="Enter user name">
                                        @error('UserName')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="login_id" class="form-control @error('login_id') is-invalid @enderror"
                                               value="{{ old('login_id') }}" placeholder="Enter login ID">
                                        @error('login_id')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
