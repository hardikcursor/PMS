                        ...
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <a href="{{ route('admin.posuser.addnewposuser') }}" class="btn btn-primary">Add
                                        Pos User</a>
                                </ol>
                            </div>
                                        ...
                                        @forelse ($posUsers as $key => $posUser)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                  <a href="{{ route('admin.posuser.editposuser', $posUser->id) }}"
                                                        class="edit-row"><i class="fas fa-edit text-warning"></i></a>
                                                    <form
                                                        action="{{ route('admin.posuser.deleteposuser', $posUser->id) }}"
