                        ...
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <a href="{{ route('admin.adddevices.create') }}" class="btn btn-primary">Add
                                        Device</a>
                                    ...
                                    <tbody >
                                        @forelse ($postmachine as $index => $machine)
                                            <tr>
                                                ...
                                                <td >
                                                    <a href="{{ route('admin.adddevices.edit', $machine->id) }}"
                                                        class="edit-row"><i class="fas fa-edit text-warning"></i></a>
                                                    <form
                                                        action="{{ route('admin.adddevices.destroy', $machine->id) }}"
